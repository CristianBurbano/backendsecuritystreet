...
class EvidencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evidence" do
    assert_difference('Evidence.count') do
      post evidences_url, params: { evidence: { alarm_id: @evidence.alarm_id, notaEvidencia: @evidence.notaEvidencia, rutaEvidencia: @evidence.rutaEvidencia, user_id: @evidence.user_id } }
    end
  ...
  test "should update evidence" do
    patch evidence_url(@evidence), params: { evidence: { alarm_id: @evidence.alarm_id, notaEvidencia: @evidence.notaEvidencia, rutaEvidencia: @evidence.rutaEvidencia, user_id: @evidence.user_id } }
