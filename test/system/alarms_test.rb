...
class AlarmsTest < ApplicationSystemTestCase
  ...
  test "creating a Alarm" do
    ...
    fill_in "Descripcion", with: @alarm.descripcion
    fill_in "Estado", with: @alarm.estado
    fill_in "Latitud", with: @alarm.latitud
    fill_in "Longitud", with: @alarm.longitud
    fill_in "Tipoalarma", with: @alarm.tipoAlarma
